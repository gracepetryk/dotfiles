# Generated by Powerlevel10k configuration wizard on 2024-11-12 at 19:17 PST.
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_DIRENV_VISUAL_IDENTIFIER_EXPANSION='!env'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%n%7F@%166F%m'
