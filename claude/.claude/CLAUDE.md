...
- Whenever posting content to Jira, GitHub, or any other external tool (comments, PR
  descriptions, issues, etc.), append a footer in the form "*Generated by Claude
  <your actual model's friendly name>*" — use whichever model is actually running,
  not a hardcoded example. No reasoning effort. Applies across all projects.
